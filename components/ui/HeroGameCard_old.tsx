  ...
  return (
    <View style={styles.card}>
      ...
      <View style={styles.content}>
        ...
        {/* ML Player Props Badge */}
        {game.analysis?.mlPlayerProps?.topProps && game.analysis.mlPlayerProps.topProps.length > 0 && (
          <View style={styles.mlPropsBadge}>
            <Ionicons name="trending-up" size={12} color={colors.success} />
            <Text style={styles.mlPropsText}>
              {game.analysis.mlPlayerProps.topProps.length} High-Value Player Props
            </Text>
