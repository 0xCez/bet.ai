...
export default function PlayerStatsNBA() {
  ...
  const mapPlayerStats = (player: any) => {
    ...
    return {
      ...
      stats: {
        pointsPerGame: stats.pointsAverage || stats.pointsPerGame || 0,
        reboundsPerGame: stats.reboundsAverage || stats.reboundsPerGame || 0,
        assistsPerGame: stats.assistsAverage || stats.assistsPerGame || 0,
        stealsPerGame: stats.stealsAverage || stats.stealsPerGame || 0,
        blocksPerGame: stats.blocksAverage || stats.blocksPerGame || 0,
        fieldGoalPct: parseFloat(stats.fgPercentage) || stats.fieldGoalPct || 0,
        threePointPct: parseFloat(stats.threePtPercentage) || stats.threePointPct || 0,
        freeThrowPct: parseFloat(stats.ftPercentage) || stats.freeThrowPct || 0,
        usagePercentage: parseFloat(stats.usagePercentage) || 0,
        minutesPerGame: stats.minutesPerGame || stats.minutes || 0,
        turnoversPerGame: stats.turnoversAverage || stats.turnoversPerGame || 0,
      },
    };
  };
